...
class Cascade:
    def __init__(self,G=530.,lam=1.,sigma=1.,direct=1.,J=0.,Pt=5.,St=10.,Dt=.05,Et=.025,recognition=1.,alpha2=4.,productive=0.,beta=1.,beta_prime=10.,gain=1.4877648555011858,KG=15600.,KP=.18,KU=.35,alpha1=.17):
        ...
        self.KG,self.KP,self.KU=KG,KP,KU
        self.alpha1,self.alpha2=alpha1*sigma,alpha2
        self.recognition=recognition
        self.at=np.array([0,gain*beta*direct,gain,0,0,0,gain*beta_prime*sigma,0,0,0])
        self.at[7:]=productive*gain
