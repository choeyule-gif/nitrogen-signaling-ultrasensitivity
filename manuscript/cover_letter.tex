...
An additional paired GlnB/GlnK design uses a binding-disabled control to calibrate relative specificity, allowing conditional sequestration inference without identifying the GlnD switch. Independent published peptide measurements establish available observables, but are not presented as measured sequestration.
