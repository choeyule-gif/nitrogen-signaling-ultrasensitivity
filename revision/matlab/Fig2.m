...
%          measured first-layer coefficient; orange, the ceiling that eq (6)
...
%% Fig2A: iso-coefficient curves, measured hyperbola and the two ceilings
isoCurves = readFigData('Fig2A_isocurves.csv');
hyperbola = readFigData('Fig2A_measured_hyperbola.csv');
nuLimits = [0.5, 3.1];
etaLimits = [0.5, 3.5];
isoValues = [1, 3, 4];                  % nu*eta = 2 is hidden under the measured 2.02 curve,
