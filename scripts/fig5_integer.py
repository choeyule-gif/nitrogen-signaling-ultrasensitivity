...
plt.savefig(os.path.join(FIGURES, 'Fig5.pdf'))
save_csv("Fig5b_fits", dict(glutamine_mM=xx, **{"fit_h%d" % h: pred(fits[h].x, h, xx) for h in (1, 2, 3)}), "Fig 5b; the data points are data/jiang1998_fig2B_digitised.csv")
