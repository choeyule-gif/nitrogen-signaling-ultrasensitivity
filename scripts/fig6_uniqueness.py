...
save_csv("Fig6a_residual", dict(l=lg[m0], R=R0[m0]), "S5 Fig A: n=3, Bhat=1.5, Ghat=0.8, T_E=1, T_S=4, T_L=2")
save_csv("Fig6b_residual", dict(l=lg2[m2], R=R2[m2]), "S5 Fig B: parameters in results/counterexamples_parameters.json (condition_i)")
